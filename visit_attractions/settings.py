"""
Django settings for visit_attractions project.
...
SECRET_KEY = 'django-insecure-zis-9#ov9uzi-=7m8%_-zwfwi+xa%d0cr&aqj0%cthk^vxqk9b'
...
WSGI_APPLICATION = 'visit_attractions.wsgi.application'
